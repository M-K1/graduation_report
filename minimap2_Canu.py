...
if __name__ == '__main__':
   ...
   for filename in os.listdir(args.input_reads_dir):
      file = filename
      file = file.replace(".correctedReads.fasta", "")
      if filename.endswith(".fasta"):
          command_minimap2 = "minimap2 -a {}{}.fasta {}{}.correctedReads.fasta > {}{}.sam" .format(args.reference_dir, file, args.input_reads_dir, file, args.out_dir, file)
